...
<div id="app">
    ...
    <div id="main-footer" class="main-footer transparent-navbar py-5">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img width="180px"  src="<?php echo e(asset('assets/images/logo-absolutly.png')); ?>" />
...
<?php /**PATH E:\laravel_doc\absolutelychef_1.14.1\absolutelychef\resources\views/layouts/theme.blade.php ENDPATH**/ ?>