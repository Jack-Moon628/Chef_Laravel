            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(route('jobs_listing')); ?>" class="form-inline" method="get">
                            <div class="form-row">
                                <div class="col-auto">
                                    <input type="text" name="q" class="form-control mb-2" style="min-width: 300px;" placeholder="<?php echo app('translator')->get('app.job_title_placeholder'); ?>">
                                    <input type="text" name="location" class="form-control" style="min-width: 300px;"  placeholder="<?php echo app('translator')->get('app.job_location_placeholder'); ?>">
                                    <button type="submit" class="btn btn-danger mb-2"><i class="la la-search"></i> <?php echo app('translator')->get('app.search'); ?></button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    <div class="home-register-account-box">
                        <h4>Seek</h4>
                        <p class="box-icon"><img src="<?php echo e(asset('assets/images/employee.png')); ?>" /></p>
                ...
                <div class="col-md-4 text-center">
                    <div class="home-register-account-box">
                        <h4>Quick</h4>
                        <p class="box-icon"><img src="<?php echo e(asset('assets/images/enterprise.png')); ?>" /></p>
                ...
                <div class="col-md-4 text-center">
                    <div class="home-register-account-box">
                        <h4>Recruited</h4>
                        <p class="box-icon"><img src="<?php echo e(asset('assets/images/recruited.jpg')); ?>" /></p>
                ...
                <div class="col-md-12">
                    ...
                    <div class="call-to-action-post-job justify-content-center">
                        <div class="job-post-icon my-auto">
                            <img src="<?php echo e(asset('assets/images/job.png')); ?>" />
                        </div>
                        ...
                        <div class="job-post-button my-auto">
                            <a href="<?php echo e(route('employer_orders')); ?>" class="btn btn-danger btn-lg">Post a Job</a>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_doc\absolutelychef_1.14.1\absolutelychef\resources\views/home.blade.php ENDPATH**/ ?>