...
Route::group(['prefix'=>'dashboard', 'middleware' => 'dashboard'], function(){
    ...
    Route::group(['middleware'=>'admin_agent_employer'], function(){
        ...
        Route::group(['prefix'=>'employer'], function(){
            ...
            Route::get('orders', 'UserController@employerOrders')->name('employer_orders');

            Route::group(['prefix'=>'job'], function(){
                Route::get('new/{type}/{order}', 'JobController@newJob')->name('post_new_job');
                Route::post('new/{type}/{order}', 'JobController@newJobPost');
        ...
        Route::group(['prefix'=>'jobs'], function(){
            ...
            Route::get('approved', 'JobController@approvedJobs')->name('approved_jobs');
...
Route::get('download/file/cv/{file}', 'UserController@downloadCv')->name('download_cv');
//Route::post('process-payment', 'OrderController@order');
// Route::post('process-payment', 'OrderController@test_order_charge');
...
Route::post('pay_success_email', 'MailController@pay_success_email');
